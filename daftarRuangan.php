            ...
            <div class="col-md-9 b-r">
                ...
                <div class="card my-3 card-block d-flex no-b" >
                    <div class="card-body align-items-center d-flex justify-content-center ; color: green">
                        <div>
                            <h3 class="card-title"><font color='#FFFAF0'><font face="Courier New" color="white" size="5">DAFTAR RUANGAN <?php echo $_GET['lantai'];?><br> PEMPROV KALIMANTAN BARAT</h3></font></font>
                        </div>
                    </div>
                    <div>
                    </div>
                    ...
                    <a data-toggle="modal" data-id="<?php echo $obj->namaRuangan?>" href="#daftarModal" class="daftarModal">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <small class="text-muted"><?php echo $obj->namaRuangan?></small>
                            </div>
                        </div>
                    </a>
                </div>
