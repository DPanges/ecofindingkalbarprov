            ...
            <div class="col-md-9 b-r">
                <!-- <div class="card-group pt-3 pb-3"> -->
                    <div class="card">
                        ...
                        <iframe class="card-img-top" width="1268" height="713" src="https://www.youtube.com/embed/SzMsqIDFPLE?autoplay=1" title="SELAYANG PANDANG UPT RSUD SULTAN SYARIF MOHAMAD ALKADRIE KOTA PONTIANAK TAHUN 2021" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
            </div>
            <?php 
            include('sidebar.php');
