...
if (isset($_GET["id"])) {
    $id = (int) $_GET["id"];
    $getfile = file_get_contents('lantai.json');
    ...
    if ($jsonfile) {
        ...
        if (!empty($gambar)){
            if (in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                ...
                header("Location: editLantai.php?err=GX&id=".$id);
            }
        }else {
            $post['gambar'] = $_POST["gambarx"];
            $file = file_get_contents('lantai.json');
            $data = json_decode($file, true);
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-sm-5 col-sm-offset-3">
                                        <?php if (isset($_GET["id"])): ?>
                                            ...
                                            ?>
                                            <form method="POST" action="editLantai.php" enctype="multipart/form-data">
                                               <div class="form-group">
                                                <input type="hidden" value="<?php echo $id ?>" name="id"/>
                                                <label for="namaRuangan">Nama Lantai</label>
                                                <input type="text" class="form-control" required="required" id="nama" value="<?php echo $jsonfile["nama"] ?>" name="nama" placeholder="Nama Lantai">
                                               ...
                                               <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <input  type="hidden" class="form-control" id="gambarx" name="gambarx" value="<?php echo $jsonfile['gambar'] ?>">
                                                      <span class="help-block"></span>
                                                    <img src="gambar/<?php echo $jsonfile["gambar"] ?>" class="img-thumbnail" width="152" height="118">
                                                 <span class="help-block"></span>
                                                      </div>
