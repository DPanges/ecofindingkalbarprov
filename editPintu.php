...
if (isset($_GET["id"])) {
    $id = (int) $_GET["id"];
    $getfile = file_get_contents('pintu.json');
    ...
    if ($jsonfile) {
        ...
        if (!empty($gambar)){
            if (in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                ...
                header("Location: editPintu.php?err=GX&id=".$id);
            }
        }else {
            header("Location: editPintu.php?err=GM&id=".$id);
        }
    }
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-sm-5 col-sm-offset-3">
                                        <?php if (isset($_GET["id"])): ?>
                                            ...
                                            ?>
                                            <form method="POST" action="editPintu.php" enctype="multipart/form-data">
                                               <div class="form-group">
                                                <input type="hidden" value="<?php echo $id ?>" name="id"/>
                                                <label for="namaRuangan">Nama Ruangan</label>
                                                <input type="text" class="form-control" required="required" id="nama" value="<?php echo $jsonfile["nama"] ?>" name="nama" placeholder="Nama Ruangan">
